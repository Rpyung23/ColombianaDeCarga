import 'package:carga_colombiana/src/models/detalle_document/datum_document.dart';
...
class _DetailDocumentState extends State<DetailDocument> {
  ...
  void initState() {
    ...
    print("NUMERO DOCUMENTO : " + widget.numDocument.toString());

    BlocProvider.of<DocumentDetailBloc>(context, listen: false)
        .add(GetDocumentDetail(widget.numDocument));
  }
